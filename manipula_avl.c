...
struct nodo_avl* rotacao_dir(struct nodo_avl* nodo){
	//pelos ponteiros, desce o pai passado como argumento e sobe seu filho esquerdo, alterando a altura dos nodos e mantendo a propriedade de arvore binaria
...
struct nodo_avl* rotacao_esq(struct nodo_avl* nodo){
	//pelos ponteiros, desce o pai passado como argumento e sobe seu filho direito, alterando a altura dos nodos e mantendo a propriedade de arvore binaria
